...
-- ============================================================================
-- O teto de juros faltava no login normal do portal.
--
-- A migration 20260805000000 colocou `max_interest_cap_percent` no payload do
-- portal, mas mexeu só em `portal_login_by_token` — o caminho do link que o bot
-- manda no WhatsApp. O `portal_client_login`, que é o formulário de CPF + data
-- de nascimento e a porta principal, continuou sem o campo.
--
-- Consequência: o mesmo devedor via um valor de juros pelo link do WhatsApp e
-- OUTRO, mais alto, entrando pelo formulário — porque `computeLateFee` só
-- aplica o limite quando o campo chega. Hoje nenhum dos 249 contratos tem teto
-- definido, então ninguém foi cobrado a mais; o defeito aparecia no dia em que
-- alguém usasse o campo.
--
-- Aqui a função é recriada a partir da definição que está no banco, com dois
-- campos a mais e nada a menos.
-- ============================================================================
